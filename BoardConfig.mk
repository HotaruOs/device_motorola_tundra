...
KERNEL_TOOLCHAIN := $(shell pwd)/$(DEVICE_PATH)/eva-gcc/gcc-arm64/bin
KERNEL_TOOLCHAIN_32 := $(shell pwd)/$(DEVICE_PATH)/eva-gcc/gcc-arm/bin

TARGET_KERNEL_CROSS_COMPILE_PREFIX := aarch64-elf-
TARGET_KERNEL_CROSS_COMPILE_COMPAT_PREFIX := arm-eabi-

KERNEL_CC := $(KERNEL_TOOLCHAIN)/aarch64-elf-gcc
KERNEL_CROSS_COMPILE := $(KERNEL_TOOLCHAIN)/aarch64-elf-
KERNEL_CROSS_COMPILE_COMPAT := $(KERNEL_TOOLCHAIN_32)/arm-eabi-
KERNEL_CC_COMPAT := $(KERNEL_TOOLCHAIN_32)/arm-eabi-gcc

KERNEL_MAKE_FLAGS := \
    ARCH=arm64 \
    CC=$(KERNEL_TOOLCHAIN)/aarch64-elf-gcc \
    CROSS_COMPILE=$(KERNEL_TOOLCHAIN)/aarch64-elf- \
    CROSS_COMPILE_COMPAT=$(KERNEL_TOOLCHAIN_32)/arm-eabi- \
    CC_COMPAT=$(KERNEL_TOOLCHAIN_32)/arm-eabi-gcc \
    AR=$(KERNEL_TOOLCHAIN)/aarch64-elf-ar \
    OBJDUMP=$(KERNEL_TOOLCHAIN)/aarch64-elf-objdump \
    STRIP=$(KERNEL_TOOLCHAIN)/aarch64-elf-strip
